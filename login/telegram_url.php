        ...
        <h4><i class="fa fa-info"></i> Note:</h4>
         <div class="info-box bg-green">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Fantanstics Tools</span>
              <span class="info-box-number">Telegram Platform...... A Good option</span>
        ...
        <div class="col-md-8">
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Capacity Building Tools</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="box-group" id="accordion">
                ...
                <p>telegram <br>
                      You can promote this anywhere, not only in Telegram. Post your proof on Whatsapp, LINE, WeChat, Twitter, FB and many more. 
                ...
                <p>Registration form with your email in the invite column qualifies you a sponsor.</p>
         ...
         <div class="col-md-4">
          <div class="box box-warning box-solid">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              You can shorten/hide your URL with this services <br>
